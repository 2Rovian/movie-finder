  ...
  return (
    <div className='h-[70px] bg-slate-900 text-white'>
      <div className='container lg:max-w-none mx-auto px-4 flex items-center h-full'>
        ...
        <div
          className={`grow flex items-center rounded-xl py-1 pl-2 bg-slate-800 outline-2 mx-4 ease-in-out duration-500 ${
            isInputFocus ? 'outline-indigo-400' : 'outline-transparent'
          }`}
          ref={inputRef}
        >
          <input
